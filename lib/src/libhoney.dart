...
class Libhoney {
  ...
  /// The name of a default dataset for events to be sent to. Must be set in Libhoney
  /// or on an [Event] or else [MissingDatasetName] will be thrown.
  String? dataset;

  /// Known to Honeycomb as an API key. Keep this a secret. Required on Libhoney 
  /// or on an [Event] or else [MissingWritekey] will be thrown.
  String? writeKey;
